...
import { t as assessmentsService } from "./assessmentsService-B6eI8cYs.js";
import { t as aiService } from "./aiService-CiJA7GdB.js";
import { t as rolePlayService } from "./rolePlayService-DZYNCBV9.js";
import { t as Route } from "./_app.courses._courseId.lessons._lessonId-CNykViHL.js";
...
import { ArrowLeft, ArrowRight, CheckCircle2, ClipboardCheck, Download, ExternalLink, FileText, Link as Link$1, Lock, MessageCircleMore, PanelRightClose, PanelRightOpen, PlayCircle, Send, Sparkles, Square } from "lucide-react";
	...
	if (result || finished && !inProgress && allLocked) {
		...
		return /* @__PURE__ */ jsxs(Card, {
			...
			children: [
				...
				attempt?.canStart && /* @__PURE__ */ jsx(Button, {
					onClick: () => {
						setResult(null);
						setQIndex(0);
						startMut.mutate();
			...
			children: [
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs(Link, {
						...
						className: "gap-1",
						children: [sidebarOpen ? /* @__PURE__ */ jsx(PanelRightClose, { className: "h-4 w-4" }) : /* @__PURE__ */ jsx(PanelRightOpen, { className: "h-4 w-4" }), sidebarOpen ? "Ocultar" : "ConteÃºdo"]
					})]
				}),
				activeItem.kind === "lesson" && /* @__PURE__ */ jsxs(Fragment, { children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs(Button, {
							...
							className: "gap-2",
							children: [/* @__PURE__ */ jsx(CheckCircle2, { className: "h-4 w-4" }), lesson.completed ? "ConcluÃ­da" : "Marcar como concluÃ­da"]
						}), next && /* @__PURE__ */ jsxs(Button, {
							variant: "outline",
							className: "gap-2",
							onClick: () => goItem(next),
							children: ["PrÃ³ximo ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })]
						})]
					})
				] }),
					...
					children: [
						...
						/* @__PURE__ */ jsx(TabsContent, {
							...
							children: /* @__PURE__ */ jsxs(Card, {
								...
								}), /* @__PURE__ */ jsx("p", { children: lesson.description || course.shortDescription || "Sem descriÃ§Ã£o." })]
							})
						}),
						/* @__PURE__ */ jsx(TabsContent, {
							value: "resources",
