...
import { t as certificatesService } from "./notificationsService-DL4GnbI-.js";
...
function CertificatesPage() {
	...
	const openCertificate = async (id) => {
		setBusyId(id);
		try {
			await certificatesService.openHtml(id);
		} catch (e) {
		...
		children: [/* @__PURE__ */ jsxs("header", { children: [/* @__PURE__ */ jsx("h1", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("p", {
					...
					children: "Complete um curso (100% das unidades) para conquistar seu primeiro certificado."
				})
			]
		}) : /* @__PURE__ */ jsx("div", {
			...
			children: certificates.map((c) => /* @__PURE__ */ jsxs(Card, {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs(Button, {
						...
						children: [busyId === c.id ? /* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsx(Eye, { className: "h-4 w-4" }), "Visualizar"]
