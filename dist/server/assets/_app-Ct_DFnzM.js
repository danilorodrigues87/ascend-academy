...
import { Award, Bell, BookOpen, LayoutDashboard, LogOut, Medal, Moon, PanelLeft, PlayCircle, Search, Settings, Sun, Trophy, User, X } from "lucide-react";
...
function AppLayout() {
	...
	const unread = filterNotificationsByPrefs(notifications, prefs).filter((n) => !n.read).length;
