		...
		children: [
						...
						children: [/* @__PURE__ */ jsxs(Avatar, {
							...
							children: [
								/* @__PURE__ */ jsx("p", {
									...
									children: "Olá, bem-vindo(a) de volta"
								}),
								/* @__PURE__ */ jsx("h1", {
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: isLoading ? Array.from({ length: 4 }).map((_, i) => /* @__PURE__ */ jsx(Skeleton, { className: "h-28 rounded-xl" }, i)) : /* @__PURE__ */ jsxs(Fragment, { children: [
					...
					/* @__PURE__ */ jsx(StatCard, {
						label: "Sessões seguidas",
						value: `${data?.streakDays ?? 0}`,
						icon: Flame,
						accent: "warning",
						hint: "agenda cumprida"
					})
				] })
			}),
			/* @__PURE__ */ jsxs("section", {
				...
				children: [/* @__PURE__ */ jsx(Card, {
					...
					children: isLoading ? /* @__PURE__ */ jsx(Skeleton, { className: "h-64 w-full" }) : data?.continueLesson ? /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [data.continueLesson.course.bannerUrl || data.continueLesson.course.coverUrl ? /* @__PURE__ */ jsx("img", {
								...
								children: /* @__PURE__ */ jsx("span", {
									className: "font-display text-7xl font-semibold text-primary-foreground/80",
									children: (data.continueLesson.course.title || "C").trim().charAt(0).toUpperCase()
								})
						...
						children: [/* @__PURE__ */ jsx("p", {
							className: "text-muted-foreground",
							children: "Nada para continuar agora. Quando a escola matricular você e publicar o curso, ele aparece aqui."
						}), /* @__PURE__ */ jsx(Button, {
							asChild: true,
							variant: "outline",
							children: /* @__PURE__ */ jsx(Link, {
								to: "/courses",
								children: "Ver meus cursos"
							})
						})]
					})
				}), /* @__PURE__ */ jsxs(Card, {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						className: "space-y-3",
						children: isLoading ? Array.from({ length: 3 }).map((_, i) => /* @__PURE__ */ jsx(Skeleton, { className: "h-14 rounded-lg" }, i)) : !prefs.enabled ? /* @__PURE__ */ jsxs("p", {
							className: "text-sm text-muted-foreground",
							children: [
						...
						}) : !dashNotifs.length ? /* @__PURE__ */ jsx("p", {
							className: "text-sm text-muted-foreground",
							children: "Nenhuma notificação nova."
						}) : dashNotifs.map((n) => /* @__PURE__ */ jsxs("div", {
							...
							return /* @__PURE__ */ jsxs("div", {
								...
								children: [
									/* @__PURE__ */ jsx("div", {
										...
										}) : /* @__PURE__ */ jsx(IconComp, { className: "h-4 w-4" })
									}),
									a.subtitle ? /* @__PURE__ */ jsx("p", {
										className: "mt-2 truncate text-[10px] uppercase tracking-wider text-primary/70",
										children: a.subtitle
									}) : null,
									/* @__PURE__ */ jsx("p", {
