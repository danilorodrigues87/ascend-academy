...
import { t as assessmentsService } from "./assessmentsService-DOLXZ12v.js";
import { t as aiService } from "./aiService-Bu9cnqM5.js";
import { t as rolePlayService } from "./rolePlayService-DAEYjhdl.js";
import { t as Route } from "./_app.courses._courseId.lessons._lessonId-DIigIRuQ.js";
...
import { n as CourseRatingControl } from "./CourseRating-D8Jitk1D.js";
import { useCallback, useEffect, useMemo, useRef, useState } from "react";
import { Link, useNavigate } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { useMutation, useQuery, useQueryClient } from "@tanstack/react-query";
import { toast } from "sonner";
import { ArrowLeft, ArrowRight, CheckCircle2, ClipboardCheck, Download, ExternalLink, FileText, Link as Link$1, Lock, MessageCircleMore, PanelRightClose, PanelRightOpen, PlayCircle, RefreshCw, Send, Sparkles, Square, Trash2 } from "lucide-react";
				...
				activeItem.kind === "lesson" && /* @__PURE__ */ jsxs(Tabs, {
					...
					children: [
						...
						/* @__PURE__ */ jsx(TabsContent, {
							value: "comments",
							className: "mt-4",
							children: /* @__PURE__ */ jsx(LessonComments, {
								courseId,
								lessonId
							})
						})
...
function VideoPlayer({ lesson, courseId }) {
	...
	const ping = useCallback(async (origin) => {
		try {
			...
			if (typeof res.totalMinutes === "number") {
				...
				if (session?.user) setUser({
					...session.user,
					totalStudyMinutes: res.totalMinutes
				});
			}
		} catch {}
	}, [
	...
	useEffect(() => {
		...
		const tick = () => {
			...
			if ((current?.provider || "youtube") === "private") {
...
function LessonComments({ courseId, lessonId }) {
	const { user } = useAuth();
	const qc = useQueryClient();
	...
	const post = useMutation({
		...
		onError: (e) => toast.error(e.message || "Não foi possível comentar.")
	});
	const del = useMutation({
		mutationFn: (id) => coursesService.deleteComment(courseId, lessonId, id),
	...
	return /* @__PURE__ */ jsxs(Card, {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsxs(Button, {
						...
						onClick: () => post.mutate(),
						className: "gap-1",
						children: [/* @__PURE__ */ jsx(Send, { className: "h-3.5 w-3.5" }), " Comentar"]
					})
				})
			]
		...
		}) : roots.length === 0 ? /* @__PURE__ */ jsx("p", {
			className: "text-sm text-muted-foreground",
			children: "Nenhum comentário ainda. Seja o primeiro!"
		}) : /* @__PURE__ */ jsx("ul", {
			className: "space-y-4",
			children: roots.map((c) => /* @__PURE__ */ jsxs("li", {
				...
				children: [/* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsxs("div", { children: [
						/* @__PURE__ */ jsxs("p", {
							className: "text-sm font-medium",
							children: [c.authorName, c.authorType === "staff" && /* @__PURE__ */ jsx("span", {
								className: "ml-2 rounded bg-primary/10 px-1.5 py-0.5 text-[10px] uppercase text-primary",
								children: "Equipe"
							})]
						}),
						/* @__PURE__ */ jsx("p", {
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("button", {
								...
								children: "Responder"
							}), user?.id === c.authorId && /* @__PURE__ */ jsxs("button", {
								type: "button",
								className: "inline-flex items-center gap-1 text-destructive hover:underline",
								onClick: () => del.mutate(c.id),
								children: [/* @__PURE__ */ jsx(Trash2, { className: "h-3 w-3" }), " Excluir"]
							})]
						})
					] })
				}), repliesOf(c.id).length > 0 && /* @__PURE__ */ jsx("ul", {
					className: "mt-3 space-y-3 border-l border-border/50 pl-4",
					children: repliesOf(c.id).map((r) => /* @__PURE__ */ jsxs("li", { children: [
						/* @__PURE__ */ jsxs("p", {
							className: "text-sm font-medium",
							children: [r.authorName, r.authorType === "staff" && /* @__PURE__ */ jsx("span", {
								className: "ml-2 rounded bg-primary/10 px-1.5 py-0.5 text-[10px] uppercase text-primary",
								children: "Equipe"
							})]
						}),
						...
						user?.id === r.authorId && /* @__PURE__ */ jsxs("button", {
							type: "button",
