...
export const mockRolePlayScenarios: RolePlayScenario[] = [
  {
    ...
    scenario:
      "Você trabalha como pesquisador de UX na empresa XPTO, um app de mobilidade urbana. Um usuário Premium relatou má experiência com o suporte e concordou em participar de uma entrevista de 15 minutos. Ele está frustrado, mas topou conversar. Seu objetivo é extrair insights reais, sem induzir respostas.",
    userRole: "Pesquisador de UX",
    aiRole: "Usuário Premium insatisfeito",
    aiCharacterName: "Marcos Andrade",
    aiCharacterAvatarUrl:
    ...
    criteria: [
      { key: "tech", label: "Conhecimento técnico" },
      ...
      { key: "decision", label: "Tomada de decisão" },
    ],
    difficulty: "medium",
    minScore: 70,
    basePrompt:
      "Você é Marcos Andrade, usuário Premium do app XPTO, insatisfeito com o suporte. Aja como uma pessoa real: seja direto, às vezes irônico, faça objeções, mude de assunto quando fizer sentido, e nunca entregue respostas prontas. Adapte humor e paciência conforme o aluno conduz a conversa.",
    initialPersonality: "Impaciente, direto, mas disposto a ajudar se sentir que está sendo ouvido.",
    initialMessage:
      "Oi, tudo bem? Olha, vou ser sincero: já perdi muito tempo com o suporte de vocês essa semana. Espero que essa conversa aqui valha a pena. Pode começar.",
    estimatedMinutes: 15,
  },
  {
    id: "rp_002",
    ...
    scenario:
      "Você é consultor de vendas de uma plataforma SaaS de gestão. Agendou uma call com o diretor financeiro de uma indústria que já usa uma solução concorrente há 4 anos. Ele topou 20 minutos, mas está claramente cético.",
    ...
    minScore: 75,
    basePrompt:
      "Você é Roberta Lima, CFO experiente, cética a novos fornecedores. Faça objeções reais (preço, curva de aprendizado, migração, ROI). Não facilite. Mude de assunto se o vendedor não fizer boas perguntas.",
    initialPersonality: "Analítica, questionadora, com pouco tempo.",
    initialMessage:
      "Olha, vou ser direta: já vi umas cinco apresentações parecidas com a de vocês esse semestre. O que exatamente muda aqui? Tenho 20 minutos.",
    estimatedMinutes: 20,
  },
  {
    id: "rp_003",
    ...
    scenario:
      "Você é professor(a) do 5º ano. O pai de um aluno pediu reunião porque acredita que o filho está sendo tratado injustamente. Você tem 15 minutos para conduzir uma conversa produtiva.",
    ...
    minScore: 65,
    basePrompt:
      "Você é Sr. Henrique, pai preocupado. Comece defensivo, mas abra espaço se o(a) professor(a) demonstrar escuta ativa.",
    initialPersonality: "Defensivo no início, protetor com o filho.",
    initialMessage:
      "Professor(a), obrigado por me receber. Vou direto ao ponto: acho que meu filho está sendo tratado de forma diferente dos outros e queria entender o que está acontecendo.",
    estimatedMinutes: 12,
  },
];

export const mockRolePlayHistory: RolePlaySimulation[] = [
  {
    id: "sim_hist_001",
    scenarioId: "rp_001",
