...
// ---------------- Courses ----------------
const makeLessons = (moduleId: string, base: string, count: number, unlockedUntil = 3) =>
  Array.from({ length: count }, (_, i) => ({
    id: `${moduleId}_l${i + 1}`,
    moduleId,
    title: `${base} — Aula ${i + 1}`,
    description:
      "Nesta aula você vai aprender os fundamentos, exemplos práticos e ver aplicações reais no mercado.",
    ...
    order: i + 1,
    resources: [
      { id: `${moduleId}_l${i + 1}_r1`, label: "Material da aula (PDF)", url: "#", type: "pdf" as const },
      { id: `${moduleId}_l${i + 1}_r2`, label: "Leitura complementar", url: "#", type: "link" as const },
    ],
  }));
...
export const mockCourses: Course[] = [
  {
    ...
    description:
      "Uma jornada completa para se tornar um Product Designer moderno. Do research à entrega, passando por sistemas de design, prototipação e handoff.",
    shortDescription: "Fundamentos, UX research, sistemas de design e handoff.",
    coverUrl:
      "https://images.unsplash.com/photo-1522542550221-31fd19575a2d?w=1200&h=800&fit=crop&auto=format",
    bannerUrl:
      "https://images.unsplash.com/photo-1531403009284-440f080d1e12?w=1920&h=800&fit=crop&auto=format",
    instructor: {
      id: "ins_001",
      name: "Prof. Rafael Menezes",
      avatarUrl:
        "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=256&h=256&fit=crop&auto=format",
      title: "Head of Design · ex-Nubank",
      bio: "15 anos de experiência liderando times de produto em fintechs e SaaS.",
    },
    categories: ["Design", "Produto", "UX"],
    level: "Intermediário",
    workloadHours: 42,
    estimatedMinutes: 42 * 60,
    rating: 4.9,
    ratingCount: 1284,
    progressPercent: 62,
    objectives: [
  ...
  },
  {
    ...
    description:
      "Padrões modernos, gerenciamento de estado, performance, testes e arquitetura para aplicações React em produção.",
    ...
    bannerUrl:
      "https://images.unsplash.com/photo-1550439062-609e1531270e?w=1920&h=800&fit=crop&auto=format",
    instructor: {
      id: "ins_002",
    ...
    categories: ["Programação", "Frontend", "React"],
    level: "Avançado",
    workloadHours: 38,
    estimatedMinutes: 38 * 60,
    rating: 4.8,
    ratingCount: 942,
    progressPercent: 34,
    objectives: [
  ...
  },
  {
    ...
    description:
      "Como incorporar IA no ciclo de vida do produto: descoberta, priorização, prototipação e métricas.",
    ...
    bannerUrl:
      "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?w=1920&h=800&fit=crop&auto=format",
    instructor: {
      id: "ins_003",
      name: "Prof. Igor Tavares",
      avatarUrl:
        "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=256&h=256&fit=crop&auto=format",
      title: "Product Lead · IA aplicada",
    },
    categories: ["Produto", "IA", "Estratégia"],
    level: "Intermediário",
    workloadHours: 28,
  ...
  },
  {
    ...
    description:
      "Estratégias de aquisição, ativação e retenção para produtos digitais modernos.",
    ...
    bannerUrl:
      "https://images.unsplash.com/photo-1553877522-43269d4ea984?w=1920&h=800&fit=crop&auto=format",
    instructor: {
      id: "ins_004",
      name: "Prof. Julia Rocha",
      avatarUrl:
        "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=256&h=256&fit=crop&auto=format",
    ...
    ratingCount: 388,
    progressPercent: 0,
    objectives: ["Fundamentos de growth", "Aquisição paga e orgânica", "Ativação", "Retenção"],
    modulesCount: 3,
    lessonsCount: 12,
    modules: [
      {
...
export const mockRanking: RankingEntry[] = [
  { id: "r1", name: "Marina Alves", xp: 8420, position: 1, avatarUrl: "https://i.pravatar.cc/64?img=1" },
  { id: "r2", name: "Pedro Lima", xp: 7210, position: 2, avatarUrl: "https://i.pravatar.cc/64?img=2" },
  { id: "r3", name: "Camila Duarte", xp: 6120, position: 3, avatarUrl: "https://i.pravatar.cc/64?img=3" },
  { id: "usr_001", name: "Ana Beatriz Souza", xp: 4820, position: 4, isCurrentUser: true, avatarUrl: mockUser.avatarUrl },
  { id: "r5", name: "João Vitor", xp: 4210, position: 5, avatarUrl: "https://i.pravatar.cc/64?img=5" },
  { id: "r6", name: "Rafaela Nunes", xp: 3980, position: 6, avatarUrl: "https://i.pravatar.cc/64?img=6" },
];
    ...
    questions: [
      {
        ...
        options: [
          { id: "a", label: "Entender necessidades reais dos usuários" },
          { id: "b", label: "Validar cores e tipografia" },
          { id: "c", label: "Escrever documentação técnica" },
          { id: "d", label: "Reduzir custos de desenvolvimento" },
        ],
        correctAnswer: "a",
      },
      { id: "q2", type: "boolean", prompt: "Um design system garante consistência entre produtos.", correctAnswer: true },
      { id: "q3", type: "essay", prompt: "Descreva como você conduziria um teste de usabilidade com 5 usuários." },
      { id: "q4", type: "roleplay", prompt: "Você é o PM. Um stakeholder quer cortar research. Como responder?", roleplayCharacter: "Stakeholder cético" },
    ],
  },
];
...
export const mockConversations: ChatConversation[] = [
  {
    ...
    messages: [
      { id: "m1", role: "user", content: "Como estruturar tokens de cor em um design system?", createdAt: new Date().toISOString() },
      {
        id: "m2",
        role: "assistant",
        content:
          "Ótima pergunta! Tokens de cor geralmente são organizados em três camadas: **primitivos** (paleta base), **semânticos** (background, foreground, primary...) e **de componente** (button-bg, card-bg). Isso permite trocar temas sem alterar componentes.",
